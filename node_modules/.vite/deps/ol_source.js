...
} from "./chunk-ZOZY5QGC.js";
import "./chunk-C5KGH6RQ.js";
import {
  Feature_default
} from "./chunk-DFLENWWM.js";
import {
  Layer_default as Layer_default2
} from "./chunk-OYCLBDQG.js";
...
import {
  ...
  render,
  withinExtentAndZ
} from "./chunk-POSSXH6Q.js";
import {
  ImageState_default,
  Image_default,
  decode
} from "./chunk-6IAICFDX.js";
import {
  TileQueue_default
} from "./chunk-MGQKCOO7.js";
import "./chunk-VT76Z3LM.js";
import {
  TileState_default
...
import {
  ...
  scale as scale2,
  toSize
} from "./chunk-SV6Z2GR4.js";
import {
  DEFAULT_MAX_ZOOM,
  DEFAULT_TILE_SIZE,
  ViewHint_default
} from "./chunk-OINQXF4T.js";
import {
...
addDecoder([void 0, 1], () => import("./raw-TRZF4NUM.js").then((m) => m.default));
addDecoder(5, () => import("./lzw-EXD7XJMH.js").then((m) => m.default));
addDecoder(6, () => {
  throw new Error("old style JPEG compression is not supported.");
});
addDecoder(7, () => import("./jpeg-J4KPAKMD.js").then((m) => m.default));
addDecoder([8, 32946], () => import("./deflate-C6NYXXP6.js").then((m) => m.default));
addDecoder(32773, () => import("./packbits-UZOCTHW6.js").then((m) => m.default));
addDecoder(
  34887,
  () => import("./lerc-QGDASEQ3.js").then(async (m) => {
    await m.zstd.init();
    return m;
  }).then((m) => m.default)
);
addDecoder(50001, () => import("./webimage-MWNXUOPM.js").then((m) => m.default));
  ...
  constructor(size = defaultPoolSize, createWorker2) {
    ...
    if (size) {
      this._awaitingDecoder = createWorker2 ? Promise.resolve(createWorker2) : new Promise((resolve) => {
        import("./decoder-BDR73LGL.js").then((module) => {
